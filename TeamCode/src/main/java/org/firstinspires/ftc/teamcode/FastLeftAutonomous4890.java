...
@Autonomous(name = "FAST-LEFT-Auto4890", preselectTeleOp = "Teleop4890")
public class FastLeftAutonomous4890 extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence fromStackLow = drive.trajectorySequenceBuilder((toStack3.end()))
                .addTemporalMarker(0, () -> {
                    robot.WM40.setTargetPosition(raiseRight);
                    robot.RLM.setTargetPosition(raiseLeft);
                })
        ...
        TrajectorySequence park2 = drive.trajectorySequenceBuilder(fromStack3.end())
                .back(3)
                .addTemporalMarker(0.2, () -> {
                    robot.WM40.setTargetPosition(0);
                    robot.RLM.setTargetPosition(0);
