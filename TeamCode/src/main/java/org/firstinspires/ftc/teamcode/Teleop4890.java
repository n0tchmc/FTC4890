...
public class Teleop4890 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            robot.frontLeft.setPower(FrontLeftVal * 0.75);
            robot.frontRight.setPower(FrontRightVal * 0.75);
            robot.backLeft.setPower(BackLeftVal * 0.75);
            robot.backRight.setPower(BackRightVal * 0.75);
