...
public class BlueWarehouseAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(pose).strafeLeft(40).build();
        TrajectorySequence defaultTraj = drive.trajectorySequenceBuilder(pose)
                ...
                .forward(40)
                .build();
        Trajectory traj1 = drive.trajectoryBuilder(pose).strafeLeft(40).build();
        Trajectory traj2 = drive.trajectoryBuilder(pose).strafeLeft(40).build();
        Trajectory traj3 = drive.trajectoryBuilder(pose).strafeLeft(40).build();
