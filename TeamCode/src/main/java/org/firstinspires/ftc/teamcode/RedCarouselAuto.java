...
//            traj1 = drive.trajectoryBuilder(trajSeq1.end()).splineTo(new Vector2d(-22.5, -40), Math.toRadians(60)).build();
            traj1 = drive.trajectoryBuilder(trajSeq1.end()).splineToConstantHeading(new Vector2d(-24.5, -42), Math.toRadians(90)).build();
            traj2 = drive.trajectoryBuilder(traj1.end().plus(new Pose2d(0, 0, Math.toRadians(-90)))).splineToConstantHeading(new Vector2d(-60, -34), Math.toRadians(0)).build();
...
//            traj1 = drive.trajectoryBuilder(trajSeq1.end()).splineTo(new Vector2d(-22.5, -40), Math.toRadians(60)).build();
            ...
            trajSeq1 = drive.trajectorySequenceBuilder(pose)
                    ...
                    .build();
//            traj1 = drive.trajectoryBuilder(trajSeq1.end()).splineTo(new Vector2d(-22.5, -40), Math.toRadians(60)).build();
            traj1 = drive.trajectoryBuilder(trajSeq1.end()).splineToConstantHeading(new Vector2d(-28.5, -46), Math.toRadians(90)).build();
            traj2 = drive.trajectoryBuilder(traj1.end().plus(new Pose2d(0, 0, Math.toRadians(-90)))).splineToConstantHeading(new Vector2d(-60, -34), Math.toRadians(0)).build();
        }
