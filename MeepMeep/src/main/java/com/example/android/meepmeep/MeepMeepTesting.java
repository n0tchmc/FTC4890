...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        DriveShim drive = new DriveShim(DriveTrainType.MECANUM, );

        TrajectorySequenceBuilder redWarehoue = new TrajectorySequenceBuilder(new Pose2d(12, -62, Math.toRadians(90)))
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep).setDimensions(14.5, 18)
                ...
                .setConstraints(56.9087263114899325, 56.9087263114899325, Math.toRadians(180), Math.toRadians(180), 13.45)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(12, -62, Math.toRadians(90)))
                                .splineTo(new Vector2d(2.5, -43), Math.toRadians(125))
                                .waitSeconds(1)
//                                .splineTo(new Vector2d(2, -45), Math.toRadians(0))
                                .splineToLinearHeading(new Pose2d(12, -62), Math.toRadians(0))
